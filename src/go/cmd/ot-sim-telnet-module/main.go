...
import (
	...
	// This will cause the Telnet module to register itself with the otsim package
	// so it gets run by the otsim.Start function below.
	_ "github.com/patsec/ot-sim/telnet"
)
...
func main() {
	...
	if err := otsim.Start(ctx); err != nil {
		fmt.Printf("Error starting Telnet module: %v\n", err)
		os.Exit(1)
	}
	...
	if err := ctx.Err(); err != nil && err != context.Canceled {
		fmt.Printf("Error running Telnet module: %v\n", err)
		os.Exit(1)
	}
}
